    ...
    <div class="container-fluid">
                                ...
                                <table class="table table-striped" id="myTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $row->hargajual }}</td>
                                            <td>
                                                <button class="btn btn-info btn-pilih" data-dismiss="modal">pilih</button>
                                            </td>
                                        </tr>
                                        @endforeach
                                </table>
        ...
        <script>
            ...
            function saveColumn() {
                ...
                $.get('http://localhost/PWL/latihanlaravel11/gudangmaster/' + kodetr +
                    '/' + tanggal + '/' + namasupplier + '/' + telpon +
                    '/' + alamat + '/' + keterangan + '/' + grandtotal,
                    function() {});


                console.log('http://localhost/PWL/latihanlaravel11/gudangmaster/' + kodetr +
                    '/' + tanggal + '/' + namasupplier + '/' + telpon +
                    '/' + alamat + '/' + keterangan + '/' + grandtotal);
                ...
                $('#myTableisi tr').each(function() {
                    ...
                    if (kode != "") {
                        ...
                        $.get('http://localhost/PWL/latihanlaravel11/gudangdetail/' + kodetr + '/' + kode + '/' + harga + '/' + jumlah, function() {});
                        console.log('http://localhost/PWL/latihanlaravel11/gudangdetail/' + kodetr + '/' + kode + '/' + harga + '/' + jumlah);
                        window.location = "http://localhost/PWL/latihanlaravel11/gudang";
